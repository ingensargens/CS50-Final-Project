...
top_artist = 'Pierce the Veil'
top_tracks = ["car", "HOTM", "circles"]
...
@app.route('/')
def index():
    # Debugging: Print the top_artist and top_tracks to the console
    return render_template('layout.html', top_artist=top_artist, top_tracks=top_tracks)
